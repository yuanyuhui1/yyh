...
#define REMOVE_SOFTKEY_MESSAGE_LEN_EUROPEAN 4
#define REMOVE_SOFTKEY_MESSAGE_LEN_ASIAN    4
#ifdef HMI_SUPPORTS_ASIAN
#define REMOVE_SOFTKEY_MESSAGE_LEN          (functionCode == WRITE_STRING_ASIAN ? REMOVE_SOFTKEY_MESSAGE_LEN_ASIAN : REMOVE_SOFTKEY_MESSAGE_LEN_EUROPEAN)
#else
#define REMOVE_SOFTKEY_MESSAGE_LEN          REMOVE_SOFTKEY_MESSAGE_LEN_EUROPEAN
#endif
#define COMMON_HMI_WIDTH_MIDPOINT       64
#define SOFTKEY_PAGE                    7
#endif

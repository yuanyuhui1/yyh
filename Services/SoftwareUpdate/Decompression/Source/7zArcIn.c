...
//lint -e749 some local enumeration constants are not referenced is OK
enum EIdEnum
{
  k7zIdEnd,
  k7zIdHeader,
...
//lint -esym(771, streamUsed, coderUsed) Symbol x conceivably not initialized is OK
...
//lint -e{737} Loss of sign in promotion from x to y is OK

...
/*
 ...
 Module         MODBUS_register_table_multi_buffer.h
 Description    Interface to the Modbus message buffer handling functions for multi type register tables
...
//-------------------------------------------------------------------------------------------------
    ...
    #error "Modbus_Register_Table_Multi_Buffer.h Error - Common_Type.h must be included first."
#endif

#ifndef __MODBUS_REGISTER_TABLE__
    #error "Modbus_Register_Table_Multi_Buffer.h Error - Modbus_Register_Table.h must be included first."
#endif

#ifdef __MODBUS_REGISTER_TABLE_MULTI_BUFFER_H__
    #error "Modbus_Register_Table_Multi_Buffer.h Error - Modbus_Register_Table_Multi_Buffer.h is already included."
#endif

#define __MODBUS_REGISTER_TABLE_MULTI_BUFFER_H__
//-------------------------------------------------------------------------------------------------
